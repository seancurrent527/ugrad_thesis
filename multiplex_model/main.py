...
from utils import r2_keras, ConCurrent, limit_loss
...
def model_network(input_shape):
    ...
    xhid = ConCurrent(16, 3, activation='relu', kernel_regularizer=l1(0.15))(xin)
...
def test1():
    ...
    compile_args = dict(metrics = [r2_keras], loss=limit_loss, optimizer = Adam(lr = 0.00001))
